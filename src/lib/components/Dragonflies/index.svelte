<script>
	...
	let hexColor = '#221d34'; // '#02070A';
	const colourScheme = 3;
	...
	const sketch = (p5) => {
		...
		p5.setup = () => {
			...
			const posLookup = [
				{ x: p5.random(p5.width * 0.5, p5.width * 0.5 + 200), y: p5.random(50, 200) },
				{ x: p5.random(p5.width * 0.5, p5.width * 0.5 + 400), y: p5.random(50, 200) },
